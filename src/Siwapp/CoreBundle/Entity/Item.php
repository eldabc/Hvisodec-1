...
class Item implements \JsonSerializable
{
     ...
     * @var string
     *
     * @ORM\Column(name="nLote", type="string", length=100, nullable=true)
     * @Assert\NotBlank()
     */
    private $nLote;
     ...
     * @var integer
     *
     * @ORM\Column(name="stock", type="integer", length=100, nullable=true)
     * @Assert\NotBlank()
     */
    private $stock;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Siwapp\ProviderBundle\Entity\InvoiceProvider", mappedBy="items")
     */
    ...
    {
        $this->expirationDate = $expirationDate instanceof \DateTime ?
